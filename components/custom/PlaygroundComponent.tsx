        ...
        <div className={cn(
          ...
          {!hasMedia && (
               ...
               <button 
                 ...
                 onClick={() => window.open('https://www.ridiculous.design/ridiculous-shots', '_blank')}
               >
          ...
          {showMaximizeButton && (
            <div className="absolute md:bottom-4 md:right-4 right-2 bottom-2 z-10">
              <button 
                ...
                onClick={onMaximizeClick || (() => window.open(imageSrc, '_blank'))}
              >
                <Maximize2 className="w-6 h-6 lg:w-8 lg:h-8 text-[#FFF2E9]" strokeWidth={1} />
              </button>
            </div>
          )}
          {showRedirectButton && (
