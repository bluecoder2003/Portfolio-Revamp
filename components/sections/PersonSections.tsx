      ...
      <div className="flex flex-col justify-between items-center w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col justify-between items-center w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            {/* Polaroid Grid */}
            <Image
              src="https://neelakshi.s3.us-east-1.amazonaws.com/portfolio/about-one.svg"
              alt="polaroid"
              width={100}
              height={100}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <Image
            src="https://neelakshi.s3.us-east-1.amazonaws.com/portfolio/about-two.svg"
            alt="polaroid"
            width={100}
            height={100}
        ...
        {/* Timeline Header */}
        <div
          className={`text-[#093FB4] text-2xl hidden md:block font-normal ${instrumentSerif.className} mb-4`}
        >
